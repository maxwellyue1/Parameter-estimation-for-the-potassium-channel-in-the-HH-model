...
print(f'The device of diff_weights_2d_tensor is: {diff_weights_2d_tensor.device}')
...
plt.legend()
plt.savefig(f'weights_figures/epoch {unique_id}.png')

print(train_losses)
print(norm_diff_weights_2d_tensor)